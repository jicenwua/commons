package com.xcz.member.log.config;
 ...
 */
@AutoConfiguration
@ConditionalOnClass(name = "com.xcz.member.security.utils.SecurityUtils")
    ...
    public RequestLogUserIdResolver securityRequestLogUserIdResolver() {
        return () -> {
            try {
                ...
                Class<?> securityUtils = Class.forName("com.xcz.member.security.utils.SecurityUtils");
